...
engine-client-test: engine-client-dependencies flutter-client-dependencies
	...
	@cd $(FLUTTER_CLIENT) && $(FLUTTER) test --no-pub test/features/map/infrastructure/native_large_map_smoke_test.dart test/features/map/infrastructure/native_hex_inspection_smoke_test.dart test/features/map/infrastructure/native_turn_actions_smoke_test.dart
