...
pub use response::{
    ...
    PlayerDiplomaticRelationViewDto, PlayerFogViewDto, PlayerParticipantViewDto,
    PlayerResourceTradeAgreementViewDto, PlayerTurnLifecycleViewDto, PlayerUnitViewDto,
...
pub const CLIENT_API_VERSION: u16 = 8;
