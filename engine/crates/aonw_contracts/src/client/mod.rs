...
pub use response::{
    AutoExploreOptionDto, BuildingProductionDetailsDto, CityExpansionCandidateDto,
    CityFoundingDraftViewDto, CityFoundingJobViewDto, CitySpecializationOptionDto,
    ...
    ClientParticipantControlDto, ClientQueryResultDto, ClientReplayVerificationDto,
    ClientResponseBodyDto, ClientResponseDto, ClientSessionStampDto, CulturalVictoryProgressDto,
    DetachmentOptionDto, DominationVictoryProgressDto, EconomyForecastDto, FieldImprovementViewDto,
    GoldIncomeSourceDto, HexAssessmentKindDto, HexAssessmentScoreDto, HexAssessmentTagDto,
    HexImprovementAccessDto, HexImprovementOptionDto, HexInspectionDto, HexRecommendationDto,
    MapObjectiveProgressDto, MerchantDestinationOptionDto, MerchantRouteViewDto,
    MovementSearchMetricsDto, MovementStepViewDto, OwnedCityDetailsViewDto,
    OwnedUnitDetailsViewDto, PendingActionViewDto, PendingTurnActionDto,
    ...
    PlayerViewSnapshotDto, ProductionAvailabilityDto, ProductionBuildingRankDto,
    ProductionCityOutputDto, ProductionForecastDto, ProductionOptionDto, ProductionRequirementDto,
    ProductionRequirementStatusDto, ProductionRushQuoteDto, ProductionTargetEffectsDto,
    ...
    UnitProductionDetailsDto, UnitProductionOptionDto, UnitUpkeepBreakdownDto, UnitUpkeepSourceDto,
    VictoryStatusDto, VictoryStatusKindDto, WonderProductionDetailsDto, WorkerAutomationActionDto,
...
pub const CLIENT_API_VERSION: u16 = 32;
