...
use aonw_domain::{PlayerFogState, PlayerId};
...
pub(super) fn decode_fog(
    index: usize,
    dto: PlayerFogDto,
) -> Result<PlayerFogState, GameStateMappingError> {
...
pub(super) fn encode_fog(fog: &PlayerFogState) -> PlayerFogDto {
    PlayerFogDto {
