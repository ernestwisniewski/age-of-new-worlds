...
>(symbol: 'aonw_server_native_apply_player_command', assetId: _assetId)
external ffi.Pointer<ffi.Void> aonwServerNativeApplyPlayerCommand(
  ffi.Pointer<ffi.Void> world,
  ffi.Pointer<ffi.Uint8> request,
  int requestLength,
);
...
>(symbol: 'aonw_server_native_apply_system_command', assetId: _assetId)
external ffi.Pointer<ffi.Void> aonwServerNativeApplySystemCommand(
  ffi.Pointer<ffi.Void> world,
  ffi.Pointer<ffi.Uint8> request,
  int requestLength,
);
...
>(symbol: 'aonw_server_native_replay_batch', assetId: _assetId)
external ffi.Pointer<ffi.Void> aonwServerNativeReplayBatch(
  ffi.Pointer<ffi.Void> world,
  ffi.Pointer<ffi.Uint8> request,
  int requestLength,
);
