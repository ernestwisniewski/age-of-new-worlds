...
import 'game/models/game_kick_participant_request.dart' as _i13;
...
import 'game/models/game_replay_frame.dart' as _i25;
import 'game/models/game_resign_match_request.dart' as _i26;
...
class Protocol extends _i1.SerializationManager {
  ...
  T deserialize<T>(
    ...
    if (t == _i13.GameKickParticipantRequest) {
      return _i13.GameKickParticipantRequest.fromJson(data) as T;
    }
    if (t == _i14.GameLobbyParticipantView) {
      return _i14.GameLobbyParticipantView.fromJson(data) as T;
    }
    if (t == _i15.GameLobbyView) {
      return _i15.GameLobbyView.fromJson(data) as T;
    }
    if (t == _i16.GameMatch) {
    ...
    if (t == _i25.GameReplayFrame) {
      return _i25.GameReplayFrame.fromJson(data) as T;
    }
    if (t == _i26.GameResignMatchRequest) {
      return _i26.GameResignMatchRequest.fromJson(data) as T;
    }
    ...
    if (t == _i1.getType<_i13.GameKickParticipantRequest?>()) {
      return (data != null
              ? _i13.GameKickParticipantRequest.fromJson(data)
              : null)
          as T;
    }
    if (t == _i1.getType<_i14.GameLobbyParticipantView?>()) {
      return (data != null
              ? _i14.GameLobbyParticipantView.fromJson(data)
              : null)
          as T;
    }
    if (t == _i1.getType<_i15.GameLobbyView?>()) {
      return (data != null ? _i15.GameLobbyView.fromJson(data) : null) as T;
    }
    ...
    if (t == _i1.getType<_i25.GameReplayFrame?>()) {
      return (data != null ? _i25.GameReplayFrame.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i26.GameResignMatchRequest?>()) {
      return (data != null ? _i26.GameResignMatchRequest.fromJson(data) : null)
          as T;
    }
    ...
    if (t == List<_i14.GameLobbyParticipantView>) {
      return (data as List)
              .map((e) => deserialize<_i14.GameLobbyParticipantView>(e))
              .toList()
          as T;
    }
  ...
  static String? getClassNameForType(Type type) {
    return switch (type) {
      ...
      _i13.GameKickParticipantRequest => 'GameKickParticipantRequest',
      ...
      _i25.GameReplayFrame => 'GameReplayFrame',
      _i26.GameResignMatchRequest => 'GameResignMatchRequest',
  ...
  String? getClassNameForObject(Object? data) {
    ...
    switch (data) {
      ...
      case _i13.GameKickParticipantRequest():
        return 'GameKickParticipantRequest';
      case _i14.GameLobbyParticipantView():
        return 'GameLobbyParticipantView';
      case _i15.GameLobbyView():
      ...
      case _i25.GameReplayFrame():
        return 'GameReplayFrame';
      case _i26.GameResignMatchRequest():
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (dataClassName == 'GameKickParticipantRequest') {
      return deserialize<_i13.GameKickParticipantRequest>(data['data']);
    }
    if (dataClassName == 'GameLobbyParticipantView') {
      return deserialize<_i14.GameLobbyParticipantView>(data['data']);
    }
    if (dataClassName == 'GameLobbyView') {
      return deserialize<_i15.GameLobbyView>(data['data']);
    }
    ...
    if (dataClassName == 'GameReplayFrame') {
      return deserialize<_i25.GameReplayFrame>(data['data']);
    }
    if (dataClassName == 'GameResignMatchRequest') {
      return deserialize<_i26.GameResignMatchRequest>(data['data']);
    }
