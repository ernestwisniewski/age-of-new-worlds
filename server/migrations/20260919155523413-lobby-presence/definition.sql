...
--
-- Class GameLobbyConnection as table aonw_game_lobby_connection
--
...
CREATE TABLE "aonw_game_match" (
    ...
    "initialStateJson" text,
    "initialStateDigest" text,
    "initialRevision" bigint,
    "replayBehaviorFingerprint" text,
    "state" text NOT NULL,
    "hostPlayerId" text,
    "turn" bigint NOT NULL,
    "startedAt" timestamp without time zone,
    "turnDeadlineAt" timestamp without time zone,
...
CREATE TABLE "aonw_game_participant" (
    ...
    "resignedAt" timestamp without time zone,
    "kickedAt" timestamp without time zone,
    "kickReason" text
);
...
--
-- Class GameReplayEntry as table aonw_game_replay_entry
--
...
--
-- Foreign relations for "aonw_game_lobby_connection" table
--
...
--
-- Foreign relations for "aonw_game_replay_entry" table
--
