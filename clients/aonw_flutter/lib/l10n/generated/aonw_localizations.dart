...
abstract class AonwLocalizations {
  ...
  /// No description provided for @showUnitMovementAnimations.
  ///
  /// In en, this message translates to:
  /// **'Show unit movement animations'**
  String get showUnitMovementAnimations;

  /// No description provided for @showUnitIdleAnimations.
  ///
  /// In en, this message translates to:
  ...
  String get showCombatAnimations;

  /// No description provided for @cinematicCamera.
  ///
  /// In en, this message translates to:
  /// **'Cinematic camera'**
  String get cinematicCamera;
  ...
  /// Authored technology descriptions from the reference catalog; quantitative unlocks remain supplied by Rust.
  ///
  /// In en, this message translates to:
  /// **'{technology, select, agriculture{Opens the basic growth path. Farms and river farms let population grow faster and stabilize the first city.} woodworking{Develops the production side of mining. Lumber mills turn forests into production without going deep into metallurgy.} mining{Opens the path of industry and infrastructure. Mines are the first major jump in city production.} animalHusbandry{Strengthens growth through animal resources. Pastures build a food economy and prepare the way to horseback riding.} hunting{Opens the military and exploration branch. Provides camps and the first ranged unit for city production.} fishing{Develops cities near water. Fishing boats help coastal cities grow faster and prepare the way to the port.} craftsmanship{The first city production upgrade. The workshop keeps later buildings and units from blocking the queue too long.} trade{The first step in the gold economy. The merchant hall gives a city a simple financial payoff after choosing a growth branch.} storage{Stabilizes city growth. Storage helps maintain food pace and reduces the risk of development stalls.} waterEngineering{Expands the water growth path. The water mill rewards cities that control rivers.} stoneworking{Combines production and defense. Quarries and the stonemason strengthen cities in the infrastructure branch.} militaryOrganization{Builds the first military core of a city. Barracks strengthen production and defense before later army bonuses appear.} advancedTrade{Develops the economy after trade. The marketplace is a stronger gold building and prepares the path to banking.} construction{Expands territory and city maturity. Housing increases tile control and leads to administration and engineering.} navigation{Opens a city payoff for the coast. The port requires coast/ocean access and rewards waterfront cities with food and gold.} irrigation{Specializes water-based growth. The aqueduct grants a strong food bonus and additional territorial control.} banking{Specializes the trade branch. The bank turns earlier markets into strong city income and unlocks the wider economy.} engineering{Construction specialization. The builders guild speeds production and increases the controlled tile limit.} metallurgy{A strong industrial payoff after stoneworking. The forge raises production and prepares the path to iron and coal.} horsebackRiding{A technology linking growth and war. The stable supports cities that invested earlier in animals and hunting.} ironWorking{An industrial resource effect. Each controlled iron resource increases city production.} coalMining{A later industrial resource effect. Controlled coal increases city production and supports the factory path.} machinery{A late infrastructure payoff. The factory gives a large production increase to cities that entered engineering.} administration{Links infrastructure with economy. Town halls and monuments strengthen mature cities and lead to urbanization.} logistics{Speeds unit production. This is the main technology for players who want to field armies from cities more often.} shipbuilding{Develops the coastal/exploration subbranch. The lighthouse requires coast access and strengthens waterfront cities.} tactics{Military city specialization. Training grounds add defense and production for military centers.} economy{A systemic payoff for banking. Increases gold generated by city economies.} urbanization{The final direction for large-city growth. Increases the population limit once the population system starts using hard caps.} fortifications{Strengthens city defense. Grants a defensive bonus to the city economy, with its full meaning growing after combat and siege expansion.} strategy{The final military direction. Strengthens army effectiveness as a late-game payoff after logistics.} specialization{The final civic/economy payoff. Unlocks city specializations, adds city science, and helps finish late technologies in longer matches.} writing{The first step toward science, law, and administration. The archive gives a city a permanent research base.} mathematics{Connects science with territorial planning. The surveyor office helps cities control borders more effectively.} medicine{Develops health and long-term growth in large cities through apothecaries, baths, and hospitals.} civilService{Improves management of a large empire and unlocks courts that stabilize cities.} siegecraft{Opens siege warfare. Catapults and siege workshops break fortress cities.} cartography{Develops exploration, maps, and the coast. Grants the map room and the first scout ships.} guilds{Gives production cities a stage between the workshop and industry.} law{Introduces order, policies, and civilian governance through courts.} education{Builds the full science path for cities through academies and universities.} urbanPlanning{Develops great cities and territorial control through spatial planning.} navalDoctrine{Turns ports into centers of fleets, shipyards, and force projection at sea.} steel{Introduces heavy industry and heavy infantry for the later front.} bureaucracy{Provides a major civic goal after administration: offices, ministries, museums, and parliament.} nationalism{Combines border defense, mobilization, and empire identity.} scientificMethod{Prepares late science, laboratories, observatories, and technology projects.} steamPower{Opens rail, heavier logistics, and steam industry.} electricity{Introduces power, infrastructure, and information reach.} combustion{Gives oil importance and unlocks modern frontline units.} flight{Introduces aviation, reconnaissance, and force projection over the front.} massProduction{Develops final industrial production, tanks, and assembly plants.} radio{Strengthens empire communication, visibility, and influence through broadcast towers.} nuclearPhysics{Opens the reactor, uranium, and late endgame projects.} other{}}'**
  String technologyDescription(String technology);

  /// No description provided for @outcomePresentationText.
  ///
  /// In en, this message translates to:
  ...
  /// Authored production description from the reference content catalog.
  ///
  /// In en, this message translates to:
  /// **'{key, select, academy{Strengthens science cities and prepares the path to higher education.} airfield{A military airfield for aviation, reconnaissance, and modern force projection.} apothecary{Early city health that helps maintain steady growth.} aqueduct{Delivers water, supporting growth and further city expansion.} archive{The first knowledge building, organizing records and supporting research.} armory{A better recruitment and equipment center for troops.} artisansGuild{A production stage before the factory, based on crafts and workshops.} assemblyPlant{An endgame industrial building for mass production.} bank{Centralizes finance and significantly increases city income.} barracks{Provides military infrastructure and additional defense.} borderFort{Strengthens defense and visibility on empire borders.} broadcastTower{Strengthens empire influence, visibility, and communication.} buildersGuild{Gathers construction specialists, accelerating production and territorial growth.} citadel{Late strategic defense for cities on important borders.} conscriptionOffice{Mobilizes the army and speeds preparation of new troops.} court{Develops law, city policies, and civilian control.} courthouse{Stabilizes large or captured cities through legal administration.} dryDock{A late naval port for larger warships.} factory{A later-game industrial building that grants a large production bonus.} forge{Concentrates metalworking and greatly increases production.} governorsOffice{Strengthens city specialization and territorial management.} granary{An early food building that stabilizes city growth.} harborCustoms{A port office strengthening trade and coastal control.} hospital{Late population infrastructure for long-term development.} housing{Expands living space and lets the city control more tiles.} laboratory{Support for late technology projects and modern science.} lighthouse{Strengthens the coastal economy through navigation and trade.} mapRoom{Supports exploration, visibility, and expedition planning.} marketplace{Develops urban trade and greatly increases gold income.} masterWorkshop{A specialized workshop for production-focused cities.} merchantHall{Organizes local trade and increases city income.} ministries{A limited empire building that strengthens administration and gold.} monument{A symbol of city prestige, providing gold and defense.} museum{A prestigious empire building that strengthens city influence.} navalAcademy{A naval military academy for specialized ports.} observatory{Links geography with science and supports advanced research.} parliament{A limited civic building for a mature state.} planningOffice{Develops the city through planning, production, and territorial control.} port{Opens the city to sea trade and coastal food.} powerPlant{Late energy infrastructure for strong industrial production.} publicBaths{Improve stability and growth in larger cities.} railDepot{A rail depot improving logistics and mobility between cities.} reactor{A powerful endgame building requiring uranium and strong infrastructure.} refinery{Processes oil for modern armies and late projects.} shipyard{Develops fleets and production in port cities.} siegeWorkshop{Produces and maintains the support base for siege engines.} stable{Supports breeding and logistics, adding food and production.} steelworks{Heavy industry based on iron or coal.} stonemason{Strengthens the city construction and defensive base.} storehouse{Improves harvest storage and increases stored food.} surveyorsOffice{Eases border planning and increases city control range.} townHall{The city administration center, strengthening economy and territorial control.} trainingGrounds{Develops military training and improves city defense.} university{A later science building for large, developed cities.} walls{Early city defense against the first attacks.} warCollege{A military academy that strengthens army and general coordination.} waterMill{Uses controlled river tiles to increase city food.} workshop{A basic craft center that raises city production.} worldFairGrounds{A peaceful prestige project for a rich, developed city.} other{}}'**
  String productionBuildingDescription(String key);

  /// Authored production description from the reference content catalog.
  ///
  /// In en, this message translates to:
  /// **'{key, select, archer{A ranged unit that attacks from farther away but defends poorly in melee.} catapult{A siege engine with longer range, effective against fortifications.} cavalry{A mobile strike unit that quickly responds to weak points on the front.} commander{A general commands an army, leads reconnaissance, and can act faster than regular troops.} fieldCannon{Modern field artillery for ranged bombardment.} heavyInfantry{Durable frontline infantry with high defense and solid attack.} merchant{Travels automatically between your cities along a trade route and can enter occupied friendly city centers.} reconPlane{A reconnaissance aircraft with long vision range and very high mobility.} rifleman{A modern line infantry unit, steady in attack and defense.} scout{A fast reconnaissance unit for exploring the map and detecting threats.} scoutShip{A light ship for coastal reconnaissance and protecting early sea routes.} settler{Founds new cities and expands the empire, but needs protection on the road.} spearman{Early defensive infantry, good for covering cities and stopping charges.} tank{A heavy armored unit with high strength and high mobility.} warrior{A basic combat unit for city defense and melee fighting.} warship{A strong combat ship for sea control and ranged bombardment.} worker{Improves tiles around cities, increasing food, production, and gold.} other{}}'**
