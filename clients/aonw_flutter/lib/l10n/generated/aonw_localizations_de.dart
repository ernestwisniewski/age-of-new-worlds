...
class AonwLocalizationsDe extends AonwLocalizations {
  ...
  String get waitingForPlayers =>
      'Alle menschlichen Spieler müssen verbunden und bereit sein, bevor das Spiel beginnt.';
  ...
  String get singlePlayerSetupIntro =>
      'Wähle deine Zivilisation und richte dein Spiel ein.';
  ...
  String productionText(String key) {
    String _temp0 = intl.Intl.selectLogic(key, {
      ...
      'choose': 'Wähle ein Produktionsziel für diese Stadt.',
      'ready': 'Bereit zum Abschluss',
  ...
  String outcomePresentationText(String key) {
    String _temp0 = intl.Intl.selectLogic(key, {
      ...
      'control': 'Kartenkontrolle',
      'threshold': 'Erforderliche Kontrolle',
      'other': 'Partie beendet',
    });
    return '$_temp0';
  }
  ...
  String resourceInventoryText(String key) {
    String _temp0 = intl.Intl.selectLogic(key, {
      'barter': 'Tausch',
      'importDirection': 'Importiert',
      'exportDirection': 'Exportiert',
      'title': 'Strategische Wirtschaft',
      'healthy': 'Die strategische Versorgung ist stabil.',
      'resources': 'Strategische Ressourcen',
      'alerts': 'Wirtschaftswarnungen',
      'allocations': 'Produktionszuweisungen',
      'noAllocations': 'Keine strategischen Ressourcen sind zugewiesen.',
      'sources': 'Quellen',
      'noSources': 'Keine aktiven Quellen strategischer Ressourcen.',
      'agreements': 'Aktive Abkommen',
      'noAgreements': 'Keine aktiven Ressourcenabkommen.',
      ...
      'controlled': 'Kontrollierte Vorkommen',
      'available': 'Verfügbar',
      'production': 'Inlandsproduktion',
      'imports': 'Importe',
      'exports': 'Exporte',
      'net': 'Netto / Zug',
      'stockWarningDetail':
  ...
  String resourceInventoryTradeExpiring(String resourceName, int turns) {
    ...
    return 'Das $resourceName-Abkommen läuft in $_temp0 aus';
  }
  ...
  String resourceInventoryTradeFlow(
    ...
    String _temp0 = intl.Intl.pluralLogic(
      remainingTurns,
      locale: localeName,
      other: '$remainingTurns Züge verbleibend',
      one: '1 Zug verbleibend',
    );
    return '$direction: $amount $resourceName/Zug · $price · $_temp0';
  }
  ...
  String productionProgress(int invested, int cost) {
    return '$invested / $cost Produktion';
  }

  @override
  String productionRate(int amount) {
    return '$amount Produktion / Runde';
  }

  @override
  String productionRushPrice(int production, int gold) {
    return 'Um $production beschleunigen · $gold Gold';
  }

  @override
  String productionTreasury(int gold) {
    return 'Verfügbares Gold: $gold';
  }
  ...
  String productionDetailText(String key) {
    String _temp0 = intl.Intl.selectLogic(key, {
      'storedFood': 'Gelagerte Nahrung',
      'tileLimit': 'Limit kontrollierter Felder',
      'base': 'Basis',
      'effective': 'Mit Technologie',
      'upkeep': 'Grundunterhalt / Runde',
      'supplyUsed': 'Genutzte Versorgung (ohne diese Warteschlange)',
      'supplyCost': 'Versorgungskosten',
      'resourceOptions': 'Strategische Ressourcenalternativen',
      'riverApplications': 'Berücksichtigte Flussfelder',
      'movement': 'Bewegungspunkte / Runde',
      'other': 'Basis',
    });
    return '$_temp0';
  }
