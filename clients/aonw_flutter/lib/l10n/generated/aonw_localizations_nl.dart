...
class AonwLocalizationsNl extends AonwLocalizations {
  ...
  String productionText(String key) {
    String _temp0 = intl.Intl.selectLogic(key, {
      ...
      'inProgress': 'Bezig',
      'details': 'Details',
      'completed': 'Voltooid in deze stad',
      'other': 'Productie',
    });
    return '$_temp0';
  }
  ...
  String productionBuildingDescription(String key) {
    String _temp0 = intl.Intl.selectLogic(key, {
      ...
      'armory': 'Een beter rekruterings- en uitrustingscentrum voor troepen.',
      'artisansGuild':
          'Een productiefase vóór de fabriek, gebaseerd op ambachten en workshops.',
      'assemblyPlant': 'Een eindspel industrieel gebouw voor massaproductie.',
      'bank':
          'Centraliseert de financiën en verhoogt de stadsinkomsten aanzienlijk.',
      'barracks': 'Biedt militaire infrastructuur en extra verdediging.',
      'borderFort':
      ...
      'court': 'Ontwikkelt wetten, stadsbeleid en civiele controle.',
      'courthouse':
          'Stabiliseert grote of veroverde steden door middel van juridisch bestuur.',
      'dryDock': 'Een late marinehaven voor grotere oorlogsschepen.',
      'factory':
      ...
      'governorsOffice': 'Versterkt stadsspecialisatie en territoriaal beheer.',
      'granary':
      ...
      'lighthouse': 'Versterkt de kusteconomie door navigatie en handel.',
      'mapRoom': 'Ondersteunt verkenning, zichtbaarheid en expeditieplanning.',
      'marketplace':
      ...
      'parliament': 'Een beperkt burgergebouw voor een volwassen staat.',
      'planningOffice':
          'Ontwikkelt de stad door middel van planning, productie en territoriale controle.',
      'port': 'Opent de stad voor zeehandel en kustvoedsel.',
      'powerPlant':
          'Late energie-infrastructuur voor sterke industriële productie.',
      'publicBaths': 'Verbeter de stabiliteit en groei in grotere steden.',
      'railDepot':
      ...
      'refinery': 'Verwerkt olie voor moderne legers en late projecten.',
      'shipyard': 'Ontwikkelt vloten en productie in havensteden.',
      'siegeWorkshop':
      ...
      'steelworks': 'Zware industrie op basis van ijzer of steenkool.',
      'stonemason': 'Versterkt de stadsconstructie en defensieve basis.',
      'storehouse':
      ...
      'walls': 'Vroege stadsverdediging tegen de eerste aanvallen.',
      'warCollege':
  ...
  String productionUnitDescription(String key) {
    String _temp0 = intl.Intl.selectLogic(key, {
      ...
      'fieldCannon': 'Moderne veldartillerie voor afstandsbombardementen.',
      'heavyInfantry':
      ...
      'rifleman': 'Moderne linie-infanterie, stabiel in aanval en verdediging.',
      'scout':
  ...
  String productionDetailText(String key) {
    String _temp0 = intl.Intl.selectLogic(key, {
      'storedFood': 'Opgeslagen voedsel',
      'tileLimit': 'Limiet gecontroleerde tegels',
      'base': 'Basis',
      'effective': 'Met technologie',
      'upkeep': 'Basisonderhoud / beurt',
      'supplyUsed': 'Gebruikte bevoorrading (zonder deze wachtrij)',
      'supplyCost': 'Bevoorradingskosten',
      'resourceOptions': 'Alternatieven voor strategische grondstoffen',
      'riverApplications': 'Meegetelde riviertegels',
      'movement': 'Bewegingspunten / beurt',
      'other': 'Basis',
    });
    return '$_temp0';
  }
