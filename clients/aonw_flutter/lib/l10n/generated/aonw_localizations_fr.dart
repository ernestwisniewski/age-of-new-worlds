...
class AonwLocalizationsFr extends AonwLocalizations {
  ...
  String get waitingForPlayers =>
      'Chaque joueur humain doit être connecté et prêt avant le début de la partie.';
  ...
  String productionText(String key) {
    String _temp0 = intl.Intl.selectLogic(key, {
      ...
      'choose': 'Choisissez une production pour cette ville.',
      'ready': 'Prêt à terminer',
      ...
      'inProgress': 'En cours',
      'details': 'Détails',
      'completed': 'Terminé dans cette ville',
      'other': 'Production',
    });
    return '$_temp0';
  }
  ...
  String resourceText(String key) {
    String _temp0 = intl.Intl.selectLogic(key, {
      ...
      'unrest': 'Troubles',
      'warning': 'Avertissement',
      'negativeBalance': 'La trésorerie est négative.',
      'deficitWithinThreeTurns':
          'Au revenu actuel, la trésorerie sera négative dans les trois prochains tours.',
      'shortage': 'Ressources insuffisantes pour les unités débloquées',
      'victoryCritical': 'Une condition de victoire est proche.',
      'leader': 'En tête',
      'noVictory': 'Aucune condition de victoire',
      'goalCompact': 'Objectif',
      'scoreCapCompact': 'LIMITE',
      'other': 'Ressources',
    });
    return '$_temp0';
  }
  ...
  String profileText(String value) {
    String _temp0 = intl.Intl.selectLogic(value, {
      'title': 'Votre profil',
      'description':
          'Changer de nom conserve votre compte et vos parties multijoueurs.',
      'save': 'Enregistrer le nom',
      'saved': 'Nom enregistré.',
      'taken': 'Ce nom est déjà utilisé.',
      'changed': 'Le compte a changé. Rechargez le profil.',
      'other': 'Votre profil',
    });
    return '$_temp0';
  }
  ...
  String researchRecommendationRank(int rank) {
    return 'Recommandation $rank';
  }

  @override
  String researchRecommendationTurns(int turns) {
    return 'Tours estimés : $turns';
  }

  @override
  String researchRecommendationReason(String key) {
    String _temp0 = intl.Intl.selectLogic(key, {
      'boost': 'Bonus de recherche',
      'workerYields': 'Rendements des ouvriers',
      'unlocks': 'Nouveaux déblocages',
      'effects': 'Effets technologiques',
      'nearCompletion': 'Presque terminé',
  ...
  String outcomePresentationText(String key) {
    String _temp0 = intl.Intl.selectLogic(key, {
      ...
      'control': 'Contrôle de la carte',
      'threshold': 'Contrôle requis',
      'other': 'Partie terminée',
    });
    return '$_temp0';
  }
  ...
  String resourceInventoryText(String key) {
    String _temp0 = intl.Intl.selectLogic(key, {
      'barter': 'troc',
      'importDirection': 'Importation',
      'exportDirection': 'Exportations',
      'title': 'Économie stratégique',
      'healthy': 'L’approvisionnement stratégique est stable.',
      'resources': 'Ressources stratégiques',
      'alerts': 'Alertes économiques',
      'allocations': 'Allocations de production',
      'noAllocations': 'Aucune ressource stratégique n’est allouée.',
      'sources': 'Sources',
      'noSources': 'Aucune source active de ressources stratégiques.',
      'agreements': 'Accords actifs',
      'noAgreements': 'Pas d\'accord sur les ressources actives.',
      ...
      'goToCity': 'Voir la ville',
      'stored': 'Stock',
      'allocated': 'Alloué',
      'controlled': 'Dépôts contrôlés',
      'available': 'Disponible',
  ...
  String resourceInventoryTradeExpiring(String resourceName, int turns) {
    ...
    return 'L’accord de $resourceName expire dans $_temp0';
  }
  ...
  String resourceInventoryTradeFlow(
    ...
    return '$direction : $amount $resourceName/tour · $price · $_temp0';
  }
  ...
  String productionProgress(int invested, int cost) {
    return '$invested / $cost de production';
  }

  @override
  String productionRate(int amount) {
    return '$amount de production / tour';
  }

  @override
  String productionRushPrice(int production, int gold) {
    return 'Accélérer de $production · $gold or';
  }

  @override
  String productionTreasury(int gold) {
    return 'Or disponible : $gold';
  }
  ...
  String productionGoldOutput(int amount) {
    return '$amount or / tour';
  }

  @override
  String productionScienceOutput(int amount) {
    return '$amount science / tour';
  }
  ...
  String productionBuildingDescription(String key) {
    String _temp0 = intl.Intl.selectLogic(key, {
      ...
      'assemblyPlant': 'Un bâtiment industriel pour la production de masse.',
      'bank':
      ...
      'dryDock': 'Un port naval tardif pour les plus grands navires de guerre.',
      'factory':
      ...
      'ministries': 'Un empire limité qui renforce l\'administration et l\'or.',
      'monument':
      ...
      'parliament': 'Un bâtiment civique limité pour un état mature.',
      'planningOffice':
          'Développe la ville par la planification, la production et le contrôle territorial.',
      'port': 'Ouvre la ville au commerce maritime et à la nourriture côtière.',
      'powerPlant':
      ...
      'steelworks': 'Industrie lourde basée sur le fer ou le charbon.',
      'stonemason':
      ...
      'walls': 'Défense de la ville contre les premières attaques.',
      'warCollege':
  ...
  String productionDetailText(String key) {
    String _temp0 = intl.Intl.selectLogic(key, {
      'storedFood': 'Nourriture stockée',
      'tileLimit': 'Limite de cases contrôlées',
      'base': 'Base',
      'effective': 'Avec technologie',
      'upkeep': 'Entretien de base / tour',
      'supplyUsed': 'Ravitaillement utilisé (hors cette file)',
      'supplyCost': 'Coût de ravitaillement',
      'resourceOptions': 'Options de ressources stratégiques',
      'riverApplications': 'Cases de rivière prises en compte',
      'movement': 'Points de mouvement / tour',
      'other': 'Base',
    });
    return '$_temp0';
  }
