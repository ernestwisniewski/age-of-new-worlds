...
class AonwLocalizationsEs extends AonwLocalizations {
  ...
  String productionText(String key) {
    String _temp0 = intl.Intl.selectLogic(key, {
      ...
      'choose': 'Elige una producción para esta ciudad.',
      'ready': 'Listo para terminar',
  ...
  String outcomePresentationText(String key) {
    String _temp0 = intl.Intl.selectLogic(key, {
      ...
      'defeat': 'Derrota',
      'draw': 'Empate',
      'complete': 'Partida terminada',
      'control': 'Control del mapa',
      'threshold': 'Control requerido',
      'other': 'Partida terminada',
    });
    return '$_temp0';
  }
  ...
  String resourceInventoryText(String key) {
    String _temp0 = intl.Intl.selectLogic(key, {
      'barter': 'trueque',
      'importDirection': 'Importas',
      'exportDirection': 'Exportas',
      'title': 'Economía estratégica',
      'healthy': 'El suministro estratégico es estable.',
      'resources': 'Recursos estratégicos',
      'alerts': 'Alertas económicas',
      'allocations': 'Asignaciones de producción',
      'noAllocations': 'No hay recursos estratégicos asignados.',
      'sources': 'Fuentes',
      'noSources': 'No hay fuentes activas de recursos estratégicos.',
      'agreements': 'Acuerdos activos',
      'noAgreements': 'No hay acuerdos de recursos activos.',
      ...
      'stored': 'Reserva',
      'allocated': 'Asignado',
      'controlled': 'Depósitos controlados',
      'available': 'Disponible',
      'production': 'Producción nacional',
  ...
  String resourceInventoryTradeExpiring(String resourceName, int turns) {
    ...
    return 'El acuerdo de $resourceName vence en $_temp0';
  }
  ...
  String resourceInventoryTradeFlow(
    ...
    String _temp0 = intl.Intl.pluralLogic(
      remainingTurns,
      locale: localeName,
      other: 'quedan $remainingTurns turnos',
      one: 'queda 1 turno',
    );
    return '$direction: $amount $resourceName/turno · $price · $_temp0';
  }
  ...
  String productionProgress(int invested, int cost) {
    return '$invested / $cost de producción';
  }

  @override
  String productionRate(int amount) {
    return '$amount de producción / turno';
  }

  @override
  String productionRushPrice(int production, int gold) {
    return 'Acelerar en $production · $gold de oro';
  }

  @override
  String productionTreasury(int gold) {
    return 'Oro disponible: $gold';
  }
  ...
  String productionTurns(int turns) {
    String _temp0 = intl.Intl.pluralLogic(
      turns,
      locale: localeName,
      other: 'Aproximadamente $turns turnos',
      one: 'Aproximadamente 1 turno',
    );
    return '$_temp0';
  }
  ...
  String productionDetailText(String key) {
    String _temp0 = intl.Intl.selectLogic(key, {
      'storedFood': 'Alimentos almacenados',
      'tileLimit': 'Límite de casillas controladas',
      'base': 'Base',
      'effective': 'Con tecnología',
      'upkeep': 'Mantenimiento base / turno',
      'supplyUsed': 'Suministro utilizado (sin esta cola)',
      'supplyCost': 'Coste de suministro',
      'resourceOptions': 'Alternativas de recursos estratégicos',
      'riverApplications': 'Casillas de río aplicadas',
      'movement': 'Puntos de movimiento / turno',
      'other': 'Base',
    });
    return '$_temp0';
  }
