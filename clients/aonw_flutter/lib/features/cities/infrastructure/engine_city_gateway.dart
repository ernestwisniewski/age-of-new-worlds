...
final class EngineCityGateway {
  const EngineCityGateway({CityViewMapper mapper = const CityViewMapper()})
    : _mapper = mapper;
...
CitySessionException _transportFailure(EngineSessionTransportException error) =>
