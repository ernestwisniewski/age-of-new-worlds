...
typedef EngineGameSessionContext = ({
...
typedef EngineGameSessionContextReader = EngineGameSessionContext Function();

VisibleUnitView requireControlledUnit(
  EngineGameSessionContext context,
  String unitId,
) {
  // Ownership is visible in the recipient projection. Engine still decides whether
